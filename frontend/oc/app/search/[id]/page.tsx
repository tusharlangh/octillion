...
export default async function SearchPage({ params }: SearchPageProps) {
  ...
  return (
    <main className="bg-[#F5F5F7] dark:bg-[#0B0B0C] h-full w-full p-2 md:p-4">
      <section
        about="central"
        className="flex flex-col relative h-full bg-white dark:bg-[#0B0B0C] w-full rounded-[10px] shadow-sm pt-10 md:pt-0"
      >
        <SearchManager>
          <Header id={id} />
          <Result />
