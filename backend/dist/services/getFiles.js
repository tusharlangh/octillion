...
function _getFiles() {
  _getFiles = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(id, userId) {
    var result, links, urls, _loop, i, _t2;
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        ...
        case 8:
          ...
          throw _t2;
        case 9:
          console.error("Unexpected error in getFiles:", _t2);
          throw new _errorHandler.AppError("Failed to retrieve files: ".concat(_t2.message || "Unknown error"), 500, "GET_FILES_ERROR");
        case 10:
          return _context4.a(2);
      }
    }, _callee3, null, [[0, 8]]);
