...
function _getName() {
  _getName = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(userId) {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        ...
        case 1:
          ...
          return (0, _pRetry["default"])(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
            ...
            onFailedAttempt: function onFailedAttempt(error) {
              console.warn("getName: retry attempt ".concat(error.attemptNumber, "/3 for userId: ").concat(userId, ", error is: ").concat(error));
            }
          });
        case 2:
          result = _context2.v;
          return _context2.a(2, {
            success: true,
            name: (result === null || result === void 0 || (_result$user_metadata = result.user_metadata) === null || _result$user_metadata === void 0 ? void 0 : _result$user_metadata.name) || null
          });
        case 3:
          _context2.p = 3;
          _t = _context2.v;
        ...
        case 4:
          ...
          throw new _errorHandler.AppError("Failed to retrieve name: ".concat(_t.message || "Unknown error"), 500, "GET_NAME_ERROR");
        case 5:
          return _context2.a(2);
      }
    }, _callee2, null, [[0, 3]]);
