...
var handler = exports.handler = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(event, context) {
    var serverlessHandler, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          serverlessHandler = (0, _serverlessHttp["default"])(_server["default"], {
            provider: "aws",
        ...
        case 2:
          ...
          return _context.a(2, {
            ...
            body: JSON.stringify({
              ...
              message: _t.message,
              stack: process.env.NODE_ENV === "production" ? undefined : _t.stack
            })
          });
      }
    }, _callee, null, [[0, 2]]);
